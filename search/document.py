...
class DocSection:
    ...
    SECTIONS = {
    # API
    1: ("/docs/api/functions/", "Qiskit Functions"),
    2: ("/docs/api/pauli-prop/", "Pauli propagation"),
    3: ("/docs/api/qiskit/", "Qiskit SDK"),
    ...
    8: ("/docs/api/qiskit-addon-paulice/", "Qiskit Paulice API documentation"),
    9: ("/docs/api/qiskit-addon-pna/", "Qiskit propagated noise absorption"),
    10: ("/docs/api/qiskit-addon-slc/", "Shaded lightcones"),
    11: ("/docs/api/qiskit-addon-sqd/", "Sample-based quantum diagonalization (SQD)"),
    12: ("/docs/api/qiskit-addon-utils/", "Addon utilities"),
    13: ("/docs/api/qiskit-c/", "Qiskit SDK C API"),
    14: ("/docs/api/qiskit-fermions/", "Qiskit Fermions"),
    15: ("/docs/api/qiskit-fermions-c/", "Qiskit Fermions"),
    16: ("/docs/api/qiskit-ibm-runtime/", "IBM Quantum Compute client"),
    17: ("/docs/api/qiskit-ibm-transpiler/", "Qiskit Transpiler Service client"),

    # Documentation
    100: ("/docs/guides/", "Guides"),
    101: ("/docs/addons/pauli-prop/", "Pauli propagation"),
    102: ("/docs/addons/qiskit-addon-obp/", "Operator backpropagation (OBP)"),
    103: ("/docs/addons/qiskit-addon-paulice/", "Qiskit Paulice"),
    104: ("/docs/addons/qiskit-addon-pna/", "Qiskit propagated noise absorption"),
    105: ("/docs/addons/qiskit-addon-slc/", "Shaded lightcones"),
    106: ("/docs/addons/qiskit-addon-sqd/", "Sample-based quantum diagonalization (SQD)"),
    107: ("/docs/addons/qiskit-fermions/", "Qiskit Fermions"),
    ...
    301: ("/learning/courses/designing-and-leading-quantum-projects/", "Courses / Designing and leading quantum projects"),
    302: ("/learning/courses/foundations-of-quantum-error-correction/", "Courses / Foundations of quantum error correction"),
    303: ("/learning/courses/fundamentals-of-quantum-algorithms/", "Courses / Fundamentals of quantum algorithms"),
    304: ("/learning/courses/general-formulation-of-quantum-information/", "Courses / General formulation of quantum information"),
    305: ("/learning/courses/integrating-quantum-and-high-performance-computing/", "Cources / Integrating quantum and high-performance computing"),
    306: ("/learning/courses/quantum-business-foundations/", "Courses / Quantum business foundations"),
    307: ("/learning/courses/quantum-chem-with-vqe/", "Courses / Quantum chemistry with VQE"),
    308: ("/learning/courses/quantum-computing-in-practice/", "Courses / Quantum computing in practice"),
    309: ("/learning/courses/quantum-diagonalization-algorithms/", "Courses / Quantum diagonalization algorithms"),
    310: ("/learning/courses/quantum-machine-learning/", "Courses / Quantum machine learning"),
    311: ("/learning/courses/use-a-qc-today/", "Cources / Use a quantum computer today"),
    312: ("/learning/courses/utility-scale-quantum-computing/", "Courses / Utility-scale quantum computing"),
    313: ("/learning/courses/variational-algorithm-design/", "Courses / Variational algorithm design"),
