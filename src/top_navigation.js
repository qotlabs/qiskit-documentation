...
const headerGlobalHtml = `
  ...
  <div class="cds--header__global">
    ...
    >
        <div class="cds--tooltip-trigger__wrapper">
          <button
            ...
            class="lg:hidden cds--header__action cds--btn cds--btn--lg cds--layout--size-lg cds--btn--ghost cds--btn--icon-only"
            type="button"
          >
              <svg
                focusable="false"
    ...
    <div class="hidden lg:block border-solid border-y-0 border-x border-border-subtle ml-[-1px]">
      <button
        aria-label="Open search dialog"
        class="h-full items-center text-text-secondary hover:text-text-primary max:w-[180px] cds--btn cds--btn--lg cds--layout--size-lg cds--btn--ghost"
        type="button"
      >
        <svg
          focusable="false"
          ...
          viewBox="0 0 16 16"
          aria-hidden="true"
          class="!fill-icon-secondary group-hover:!fill-icon-primary"
          xmlns="http://www.w3.org/2000/svg"
        >
          <path
