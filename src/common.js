...
export const menuStruct = [
    ...
    {title: 'API references', children: [
      ...
      {title: 'IBM Quantum Compute client', url: '/docs/api/qiskit-ibm-runtime', toc: true},
      {title: 'Qiskit Transpiler Service', url: '/docs/api/qiskit-ibm-transpiler', toc: true},
      {title: 'Qiskit addons', children: [
        {title: 'Pauli propagation', url: '/docs/api/pauli-prop', toc: true},
        ...
        {title: 'Qiskit Fermions', url: '/docs/api/qiskit-fermions', toc: true},
        {title: 'Qiskit Fermions (C API)', url: '/docs/api/qiskit-fermions-c', toc: true},
      ]},
